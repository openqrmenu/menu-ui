    ...
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      ...
      <div>
        ...
        <div class="mt-6 gap-4">
          <a href="http://goqrmenu.com:3000/auth/login/google" class="flex w-full items-center justify-center gap-3 rounded-md bg-[#fff] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0] border-2">
