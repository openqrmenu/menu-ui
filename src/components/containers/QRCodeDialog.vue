          ...
          <form>
            <div class="space-y-12">
              <div class="border-b border-gray-900/10 pb-12" id="qrdiv">
                <qrcode-vue :value="url" :size="300" level="H" id="qrblock" ref="qrcode" />
              </div>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
              ...
              <button type="button" @click="copyToClipboard"
                class="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Copy
                to Clipboard</button>
